...
of NetBox or this plugin [latest stable version](https://github.com/danner26/netbox-drawio/releases).
...
* Next, check the GitHub [issues list](https://github.com/danner26/netbox-drawio/issues)
...
* First, check the GitHub [issues list](https://github.com/danner26/netbox-drawio/issues)
